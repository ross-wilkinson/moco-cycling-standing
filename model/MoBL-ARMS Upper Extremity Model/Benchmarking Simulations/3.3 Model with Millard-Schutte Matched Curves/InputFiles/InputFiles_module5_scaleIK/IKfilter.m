...
%% Load Data
filename = 'C:\Users\dmcfarland\Desktop\MoBL-ARMS Upper Extremity Model\Benchmarking Simulations\3.3 Model with Millard-Schutte Matched Curves\InputFiles\InputFiles_module5_scaleIK\IKreach.mot';
...
fileID=fopen('C:\Users\dmcfarland\Desktop\MoBL-ARMS Upper Extremity Model\Benchmarking Simulations\3.3 Model with Millard-Schutte Matched Curves\InputFiles\InputFiles_module5_scaleIK\ikfiltered.sto','wt');
...
fprintf(fileID,'\n');
fclose(fileID);
dlmwrite('C:\Users\dmcfarland\Desktop\MoBL-ARMS Upper Extremity Model\Benchmarking Simulations\3.3 Model with Millard-Schutte Matched Curves\InputFiles\InputFiles_module5_scaleIK\ikfiltered.sto',...
