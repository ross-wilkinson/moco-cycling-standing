...
function MocoInverseCycling_s01c0101()
...
% parameters.
modelProcessor = ModelProcessor('s01modelScaled.osim');
modelProcessor.append(ModOpAddExternalLoads('s01c0101setupExternalLoads.xml'));
...
% base table.
inverse.setKinematics(TableProcessor('s01c0101inverseKinematics.mot'));
...
solution.getMocoSolution().write('3DCycling_MocoInverse_solution_s01c0101.sto');
% Generate a report with plots for the solution trajectory.
model = modelProcessor.process();
report = osimMocoTrajectoryReport(model, ...
        '3DCycling_MocoInverse_solution_s01c0101.sto', 'bilateral', true);
